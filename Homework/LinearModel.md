...
![](LinearModel_files/figure-gfm/unnamed-chunk-3-1.png)<!-- --> The
simplest way to do this is with the function lm()
...
![](LinearModel_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

### Categorical variables

If we have a categorial x variable and a continuous y variable we would
perform a t-test.

bull richness dataset.

``` r
bull.rich <- read.csv(file.choose())
```
...
![](LinearModel_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> It looks
like there is a difference, to find out we can do a t-test
...
Assuming equal variance in groups and performing a two-sample t-test is
the same result as a linear model and ANOVA on the linear model. The
p-value tells us that the slope of the line is different than 0.
...
![](LinearModel_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](LinearModel_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
