...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Plant }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\FunctionTok{file.choose}\NormalTok{())}
...
\#Question6
\href{https://github.com/GayatriBhandari/Reproducibility-GB/tree/main/CodingChallenge7}{Github}
